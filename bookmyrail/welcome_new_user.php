<?php
    ...
    if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['ccn']) && isset($_POST['address'])){

    $psql = "insert into rail_data_schema.users(name,email,password,credit_card_number,address,created_on) values('$_POST[name]','$_POST[email]','$_POST[password]','$_POST[ccn]','$_POST[address]',CURRENT_TIMESTAMP)";
...
<body>
  ...
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-family: cursive;">Credit Card Number</label>
    <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="ccn" placeholder="Enter Number">
    
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1" style="font-family: cursive;">Address</label>
  ...
  <button type="submit" class="btn btn-primary" style="font-family: cursive;">Submit</button>
    ...
    <p style="font-family: cursive;"> Have an account??
        <a href="existing_user.php">Click ME</a>
    </p>
      </div>
    </div>
